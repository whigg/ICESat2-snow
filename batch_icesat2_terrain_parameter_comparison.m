...
%path for the code
addpath('/Users/ellynenderlin/mfiles/ICESat2-snow/')

%terrain parameter file (be sure the path ends in a /)
TP_path = '/Users/ellynenderlin/Research/NASA_CryoIdaho/mountains/RCEW/DEMs/';
TP_name = 'RCEW_1m_WGS84UTM11_WGS84.tif'; %this must change for each parameter you consider

%csv (be sure the path ends in a /)
csv_path = '/Users/ellynenderlin/Research/NASA_CryoIdaho/mountains/RCEW/RCEW_csvs_2021/';
